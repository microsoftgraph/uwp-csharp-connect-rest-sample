...
> Note: To understand the code for calling Microsoft Graph in a UWP app, see [Understanding the Connect code sample] (https://graph.microsoft.io/docs/platform/uwp).
